...
public class Queen extends Piece {
	...
	public boolean checkBasicLegality(BoardSquare dest) {
		...
		boolean clearPath = SpecificPieceLegalityCheck.bishopPathCheck(this.getBoard(), this.getBoardSquare(), dest) || SpecificPieceLegalityCheck.rookPathCheck(this.getBoard(), this.getBoardSquare(), dest);
		return (((rankChange > 0 && fileChange == 0) || (rankChange == 0 && fileChange > 0)) || rankChange == fileChange) && clearPath;
	}
